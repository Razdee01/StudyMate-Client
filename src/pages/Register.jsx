...
import { UserPlus, User, Mail, Image, Lock, Eye, EyeOff } from "lucide-react";

const Register = () => {
  const { signInWithGoogle, createUser, setUser, updateUserProfile } =
    use(AuthContext);
    ...
    createUser(email, password)
      .then((result) => {
        updateUserProfile(name, photoURL).then(() => {
          // THIS IS THE KEY: Manually update the user state in context
          // This makes the navbar image appear IMMEDIATELY
          setUser({
            ...result.user,
            displayName: name,
            photoURL: photoURL,
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="form-control">
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-3 top-3 text-base-content/40 hover:text-primary transition-colors"
          ...
          <button
            type="submit"
            className="btn btn-primary w-full text-white shadow-lg mt-4 font-bold text-lg"
          >
            Register Now
          </button>
        </form>
